...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Investor Unite'),
    ...
    */
    'routes' => [
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'direct-message'),
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web','auth_for_chatify']),
