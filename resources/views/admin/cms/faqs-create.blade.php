...
@section('content')
    <div class="discriptionblock dashboard-container">
        <h2>Faqs > create</h2>
        <hr>
        <form action="{{route('admin.faqs_add_edit')}}" method="post" enctype="multipart/form-data">@csrf
            <div class="row mt-4">
                <div class="col-lg-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter value here" value="{{old('question')}}" name="question">
                        @error('question')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" placeholder="Enter value here" name="answer" id="" cols="30" rows="10">{{old('answer')}}</textarea>
                        @error('answer')
                            <span class="text-danger">
                                <strong>{{ $message }}</strong>
                            </span>
