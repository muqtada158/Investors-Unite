...
@section('content')
    ...
    <div class="discriptionblock dashboard-container">
        <h2>Packages > Add</h2>
        <hr>
        <form action="{{route('admin.store_package')}}" method="post" enctype="multipart/form-data">@csrf
            <div class="row mt-4">
                <div class="col-lg-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter value here"  name="title">
                        @error('title')
                    ...
                    <div class="mb-4">
                            ...
                            <div id="formContainer">
                                <input type="text" class="form-control mb-4" placeholder="Enter value here"  name="listing_details[]">
                            </div>
                    ...
                    <div class="mb-4">
                        <label for="exampleFormControlInput1" class="form-label text-uppercase mb-3"><i class="fa fa-question-circle text-dark" aria-hidden="true"></i> Price</label>
                        <input type="text" class="form-control" placeholder="Enter value here"  name="price">
                        @error('price')
                            <span class="text-danger">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input text-dark" type="checkbox" id="flexSwitchCheckDefault" name="status" value="1">
                        </div>
                    </div>
                </div>
                <div class="row">
