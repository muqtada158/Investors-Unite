...
<div class="discriptionblock dashboard-container">
    ...
    <div class="row ">
        <div class="col-sm-auto">
            <a href="{{route('admin.create_package')}}" class="btn btnsize btn-mobile-block  box-shadow-blue btn-primary custom-padding-btn btn-lg ">
        ...
        <script type="text/javascript">
            $(function () {
                var table = $('.data-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('admin.package_listing') }}",
                    },
                    columns: [
