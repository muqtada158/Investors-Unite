...
<div class="discriptionblock dashboard-container">
    ...
    <div class="row ">
        <div class="col-sm-auto">
            <a href="{{route('dashboard.property_step_1')}}" class="btn btnsize btn-mobile-block  box-shadow-blue btn-primary custom-padding-btn btn-lg ">
        ...
        {{-- <div class="col-sm-auto">
            <a href="#" class="btn btnsize btn-mobile-block  btn-secondary custom-padding-btn btn-lg ">
                Change Outline
            </a>
        </div> --}}
    </div>
        ...
        <script type="text/javascript">
            $(function () {
                var table = $('.data-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('dashboard.property_listing') }}",
                    },
                    columns: [
                        ...
                        {data: 'property_status', name: 'property_status', orderable: false},
