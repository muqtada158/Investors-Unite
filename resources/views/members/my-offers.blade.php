...
@section('content')
    <div class="main">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="discriptionblock">
                    <h2 class="mb-4 pb-1">My offers</h2>
                </div>
            </div>
        ...
        <div class="row gx-3">
                        ...
                        <div class="row">
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <div class="card-image">
                                    <img class="w-100" src="{{asset($offer->getProperty->getImages[0]->image)}}" alt="">
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="card-content">
                                    <div class="mb-2">Date offer was made: <strong>{{ $offer->created_at->format('d-m-Y') }} </strong></div>
                                    <div class="mb-2">Address: <strong>{{$offer->getProperty->complete_address}}</strong>
                                    </div>
                                    <div class="mb-2"> Offer Price: <strong class="me-3 ms-2 usecomma">${{$offer->offer_price}}</strong> EMD: <a
                                            href="#" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                            title="Earnest Money Deposit"><img src="{{asset('user/images/info-icon.png')}}" class="info-icon"
                                                alt=""></a> <strong class="me-3 ms-2 usecomma">${{$offer->earnest_deposit}}</strong></div>
                                    <div class="mb-2">Listing Agent: <strong>{{$offer->getProperty->getMember->name}}</strong></div>
                                    <div class="mb-2">Company Name: <strong>{{$offer->getProperty->getMember->company}}</strong></div>
                                    <div class="row gx-2 mt-3">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{route('property_detail',[$offer->getProperty->id])}}" class="btn btnsize btn-secondary py-3 btn-lg px-3 px-xxl-3"><i
            ...
            @endforelse
            {{ $myoffers->links('pagination::bootstrap-5') }}
        </div>
    </div>
@endsection
