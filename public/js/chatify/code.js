  ...
  if (messenger != 0) {
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        $(".messenger-infoView .info-phone").text(data.fetch.phone);
        $(".messenger-infoView .info-phone-only").attr('href', 'tel:'+data.fetch.phone);
...
if (/Windows/.test(userAgent)) {
    ...
    let initialHeight = window.innerHeight;
        ...
        function adjustHeight(currentHeight) {
            // Example: Adjust the height of the content based on keyboardHeight and currentHeight
            const contentElement = document.getElementsByClassName("messenger-messagingView");
            contentElement.style.height = (currentHeight - keyboardHeight) + "px";
        }
    ...
    function adjustHeight(height) {
        const messagingViewHeight = height - keyboardHeight;
        $(".messenger-messagingView").css({ height: messagingViewHeight + "px" });
    }
