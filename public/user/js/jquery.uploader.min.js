	...
	class h {
		...
		createFileCardEle(e, i, r) {
			let l = (r = r || p(i)) === a ? `<img alt="preview" class="files_img" src="${i}"/>` : '<div class="file_other"></div>',
				o = t()(`<div class="jquery-uploader-card" id="${e}">\n                    <div class="jquery-uploader-preview-main">\n                        <div class="jquery-uploader-preview-action">\n                            <ul>\n                               \x3c!-- <li class="file-detail"><i class="fa fa-eye"></i></li> !--\x3e\n                                <li class="file-delete"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="9" r="9" fill="#27292D"/><path d="M9.18187 8.4749L11.6568 6L12.3637 6.70697L9.88884 9.18187L12.3637 11.6568L11.6568 12.3637L9.18187 9.88884L6.70697 12.3637L6 11.6568L8.4749 9.18187L6 6.70697L6.70697 6L9.18187 8.4749Z" fill="white"/></svg>
		...
		handleFileSelect() {
			t()(`<input type="file" ${this.options.multiple?"multiple":""} />`).on("change", (e => {
